-- Please note that these are meant to be used with a coroutine based
-- evented application. Eg. for writing serial looking code that isn't, or
-- in other words: avoiding callback soup. Using spook for running tests,
-- for example - this may not be very useful. Depending on what you do ofc.
